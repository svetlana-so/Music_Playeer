...
export const PlayPause: React.FC<PlayPauseProps> = ({isPlaying,playPause}) => {
  ...
  return (
    <div><button className='focus:outline-none' onClick={playPause}>
    {isPlaying ? <FaRegPauseCircle size={50} style={iconStyle}
    onMouseEnter={handleMouseEnter}
    onMouseLeave={handleMouseLeave}/> : <FaRegPlayCircle size={50} style={iconStyle}
    onMouseEnter={handleMouseEnter}
